...
export default async function Home() {
  ...
  const newProduct = productList?.filter((item: any) => {
    return item.tags.find((iem: any) => iem.title_tag === "new");
  });
  const iphoneProduct = productList?.filter((item: any) => {
    return item.tags.find((iem: any) => iem.title_tag === "iphone");
  });
  const samsungProduct = productList?.filter((item: any) => {
    return item.tags.find((iem: any) => iem.title_tag === "samsung");
  });
  const xiamomiProduct = productList?.filter((item: any) => {
    return item.tags.find((iem: any) => iem.title_tag === "xiamomi");
  });
