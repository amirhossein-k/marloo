...
const Footer = () => {
  return (
    <footer
      className="bg-gray-200 text-gray-700 pt-10 pb-6 px-4 md:px-20 rounded-tr-md rounded-tl-md relative z-20 w-full"
      dir="rtl"
    >
        ...
        <div>
          ...
          <form className="flex flex-col sm:flex-row items-center">
            <input
              ...
              className="w-full sm:w-auto flex-1 p-2 border border-gray-300 rounded mb-2 sm:mb-0 sm:mr-2"
            />
            <button
              type="submit"
